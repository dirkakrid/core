...
# This is a simple demo CGI script that illustrates how to use Weaved SSH as a Service in
# CGI mode.
...
case "${REQUEST_METHOD}" in
  ...
  *) # First time that the CGI script was called. Show initial HTML page.
     ...
     <html>
       <head>
         <title>Demo CGI for Weaved SSH as a Service</title>
       </head>
       <body>
         <h1>Weaved SSH as a Service</h1>

         <p>This is a demo CGI script for Weaved SSH as a Service. It shows how to execute
         Weaved SSH as a Service in one-shot CGI mode.</p>
